...
def main(infile, outpath, bank='bank', fontsize=28, ticksize=22, figsize=(15,11), tempfile=None):
    ...
    if True:
        ...
        axs2[0].set_xlabel(r'$m_{1}$ $(M_{\odot})$', fontsize=fontsize)
        axs2[0].set_ylabel(r'$m_{2}$ $(M_{\odot})$', fontsize=fontsize)
        ...
        axs2[1].set_xlabel(r'Grover iterations', fontsize=fontsize)
        ...
        fig2.savefig(outpath+'.'.join(infile.split('/')[-1].split('.')[:-1])+'_mass_ani_still.png',bbox_inches='tight')
